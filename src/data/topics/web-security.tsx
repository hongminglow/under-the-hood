...
export const webSecurityTopic: Topic = {
	...
	content: [
		...
		<h2 key="attack-map-title" className="text-xl font-bold text-slate-900 dark:text-white mt-10 mb-4">
		...
		<h2 key="xss-title" className="text-xl font-bold text-slate-900 dark:text-white mt-10 mb-4">
			XSS: The Attack That Executes as Your User
		</h2>,
		<p key="xss-desc" className="text-slate-700 dark:text-slate-400 leading-relaxed">
...
export function TrustedRichText({ html }: { html: string }) {
  ...
  return <div dangerouslySetInnerHTML={{ __html: safeHtml }} />;
		...
		<h2 key="csrf-title" className="text-xl font-bold text-slate-900 dark:text-white mt-10 mb-4">
			CSRF: When the Browser Sends Trust to the Wrong Place
		</h2>,
		<p key="csrf-desc" className="text-slate-700 dark:text-slate-400 leading-relaxed">
...
app.post("/account/email", requireAuth, (req, res) => {
  ...
  res.json({ ok: true });
		...
		<h2 key="history-attacks-title" className="text-xl font-bold text-slate-900 dark:text-white mt-10 mb-4">
		...
		<h2 key="modern-title" className="text-xl font-bold text-slate-900 dark:text-white mt-10 mb-4">
		...
		<h2 key="prevention-title" className="text-xl font-bold text-slate-900 dark:text-white mt-10 mb-4">
...
Permissions-Policy: camera=(), microphone=(), geolocation=()`}
		/>,
		<p key="closing" className="text-slate-700 dark:text-slate-400 leading-relaxed mt-8">
