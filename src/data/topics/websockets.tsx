...
wss.on('connection', (ws) => {
  ...
  ws.on('close', () => {
    ...
    <Table
      ...
      headers={["Feature", "<span class='text-emerald-700 dark:text-emerald-400'>WebSockets</span>", "<span class='text-cyan-700 dark:text-cyan-400'>Server-Sent Events (SSE)</span>", "<span class='text-amber-700 dark:text-amber-400'>Long Polling</span>"]}
      rows={[
