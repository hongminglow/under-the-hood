...
> = {
  ...
  emerald: {
    ...
    headRow: "bg-emerald-900/20 border-emerald-900/50",
    headCell: "text-emerald-300/80",
    body: "divide-emerald-900/35",
    row: "hover:bg-emerald-900/15",
    highlightedRow: "bg-emerald-900/30 hover:bg-emerald-900/40",
    cell: "text-emerald-100/75",
    highlightedCell: "text-emerald-200 italic font-bold",
  },
  teal: {
